...
#define USART_EN_Tx                          ((uint16_t)0x0001)
#define USART_EN_Rx                          ((uint16_t)0x0002)
#define IS_USART_TxRxEN(USART_EN) ((((USART_EN) & (uint16_t)0xFFFC) == 0x00) && ((USART_EN) != (uint16_t)0x00))

/** @defgroup USART_INV 
  * @{
  */

#define USART_INV_Tx                         ((uint16_t)0x0020)
#define USART_INV_Rx                         ((uint16_t)0x0010)
#define IS_USART_TxRxINV(USART_INV) ((((USART_INV) & (uint16_t)0xFFCF) == 0x00) && ((USART_INV) != (uint16_t)0x00)) 
